...
The Axes widget shows the XYZABC values of the axes of your CNC controller.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Widget / XYZABC Axes
...
| Description           | The Axes widget shows the XYZABC values of the axes of your CNC controller. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/agamenmon/widget-axes/master/auto-generated-widget.html |
| Edit URL              | http://ide.c9.io/thanhson93hcm/widget-axis |
| Github URL            | http://github.com/agamenmon/widget-axes |
| Test URL              | https://preview.c9users.io/thanhson93hcm/widget-axis/widget.html |
...
chilipeppr.load(
  "#myDivWidgetXyz",
  "http://raw.githubusercontent.com/agamenmon/widget-axes/master/auto-generated-widget.html",
  function() {
    ...
    cprequire(
      ...
      function(myObjWidgetXyz) {
        ...
        console.log("Widget / XYZABC Axes just got loaded.", myObjWidgetXyz);
        myObjWidgetXyz.init();
      }
    );
  }
